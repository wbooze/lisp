...
(defun ucs-codes-g (start row col &key (stream *standard-output*) y-spacing x-spacing g) ;; graphics version
                          ...
                          (formatting-row (stream)
                                          (do ((j 1 (1+ j)))
                                            ...
                                            (formatting-cell (stream)
                                                             (if g
                                                                 (if (graphic-char-p (code-char x))
                                                                     (ucs-insert x)
                                                                     (incf x))
                                                                 (format stream "~a ~s" (code-char x) (code-char x)))
                                                             (incf x)))))))))
